    ...
    (
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 20 }}>
          <div style={{ width: 44, height: 44, borderRadius: 10, background: "#F9750D" }} />
          <div style={{ fontSize: 30, letterSpacing: 6, textTransform: "uppercase", color: "#FCA355" }}>
            Iglesia
          </div>
        </div>
        <div style={{ marginTop: 40, fontSize: 76, fontWeight: 700, lineHeight: 1.1, maxWidth: 900 }}>
          Una comunidad creciendo en fe y propósito
        </div>
        <div style={{ marginTop: 32, fontSize: 30, color: "#A6AEC7" }}>{SITE_NAME}</div>
      </div>
    ),
    size,
  );
