...
export function EventosSection({ data }: Props): ReactElement {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="space-y-3 z-10">
                                    <span
                                        className={`inline-block text-xs font-bold tracking-widest uppercase px-3 py-1 rounded-full ${ev.tag}`}
                                    >
                                        {ev.category}
                                    </span>
                                    ...
                                    <div
                                        className={`flex items-center justify-center gap-2 text-sm font-medium pt-1 ${ev.muted}`}
                                    >
                                    ...
                                    <div className="flex items-center justify-center gap-3 pt-2">
                                        <button
                                            type="button"
                                            className="bg-accent text-white rounded-full px-6 py-2 text-sm font-semibold hover:bg-accent/85 transition-all duration-300"
                                        >
                                            Más info
                                        </button>
                                        <button
                                            type="button"
                                            className="border border-accent text-accent rounded-full px-6 py-2 text-sm font-semibold hover:bg-accent/10 transition-all duration-300"
                                        >
                                            Registrarse
                                        </button>
                                    </div>
