...
export const SocialLinks = (): ReactElement => {
	return (
		<ul className={classes.socialLinks}>
			<li>
				<Link
					href="https://www.facebook.com/Iglesiamaranathasc"
					target="_blank"
				>
					<Facebook />
			...
			<li>
				<Link
					href="https://api.whatsapp.com/send?phone=582763565704"
					target="_blank"
				>
					<Whatsapp />
					+58 276-3565704
			...
			<li>
				<Link
					href="https://www.tiktok.com/@generacion_jef"
					target="_blank"
				>
					<Tiktok />
					@generacion_jef
			...
			<li>
				<Link
					href="mailto:iglesiamaranathasc@gmail.com"
					target="_blank"
				>
					<Mail />
