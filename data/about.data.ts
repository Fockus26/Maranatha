	...
	lideresSenior: [
		{
			...
			description:
				'Apasionado por la excelencia en los procesos de la iglesia.',
			image: '/images/pastor.jpg',
		...
		},
		{
			...
			description:
				'Guiando a cada creyente a su próximo nivel espiritual.',
			image: '/images/pastor.jpg',
			tiktok: 'https://www.tiktok.com/',
		},
		{
			...
			description:
				'Administrando los recursos de la casa de Dios con fidelidad.',
			image: '/images/pastor.jpg',
		},
		{
			name: 'Carlos Mendoza',
