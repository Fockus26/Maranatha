	...
	carouselItems: [
		{
			...
			description:
				'Una velada de alabanza y adoración para toda la familia.',
			imageMobile:
		...
		},
		{
			...
			description:
				'Tres días de enseñanza, milagros y renovación espiritual.',
			imageMobile:
		...
		},
		{
			...
			description:
				'Una experiencia única de comunión, aventura y propósito.',
			imageMobile:
